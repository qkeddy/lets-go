...
const eventList = [{ activity: "Hiking" }, { activity: "Dinner" }, { activity: "Clubbing" }, { activity: "Movies" }, { activity: "Workout" }];

const locationList = [{ location: "Seattle" }, { location: "Philadelphia" }, { location: "Washington D.C." }, { location: "New York" }, { location: "Atlanta" }];
